...
The first line is a comment - LaTeX will ignore anything after a percentage sign when it compiles the output pdf. 
...
You can either use a LaTeX specific editor (in which case I recommend [TeXStudio](http://www.texstudio.org/)), or you can use any general purpose text editor such as [Atom](https://atom.io/), [Emacs](https://www.gnu.org/software/emacs/) with [AucTex](http://www.gnu.org/software/auctex/), or [Sublime Text](http://www.sublimetext.com/). 
You can get a full list [here](http://tex.stackexchange.com/questions/339/latex-editors-ides). 
...
* Syntax highlighting (both R and LaTeX)
* Code completion (for both R and LaTeX)
* Spell checking
...
Emacs fulfills all these criteria, but I'm not willing to put in the time to learn it. 
So I use Sublime Text 3 as my editor of choice.[^textpackages] 
I am pretty happy with it so far.
It is not free (nor open source), but you don't actually have to ever pay for it. 
It just reminds you every now and then that you haven't. 
If Sublime Text ever tries to force me to pay for it, I'll probably switch to Emacs or Atom.
It does check the rest of the boxes in my list, though! 
