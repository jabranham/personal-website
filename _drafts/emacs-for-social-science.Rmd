...
idea of what to do. I like the
[use-package](https://github.com/jwiegley/use-package)) package a
*lot* because it makes keeping track of what's going on in the
`.emacs` file much easier. 
