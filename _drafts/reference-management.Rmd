...
So although there's a bit of setup cost, once you've done that (once), you can just write your document and simply drop in citations with a simple command (like `\citep{}`).
