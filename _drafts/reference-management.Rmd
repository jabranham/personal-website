...
# The .bib file In my last post, I briefly mentioned that you should
...
# Using the .bib file in LaTeX There are two different programs and two different packages in LaTeX to manage your bibliography.  [This answer](http://tex.stackexchange.com/a/25702)
...
## BibLaTeX and Biber BibLaTeX and biber are the newer, snazzier
...
## Natbib and BibTeX Natbib and BibTeX are the older cousins of
...
# .bib file management programs There are a lot of different programs
out there that can manage your .bib file (and sync it across
